...
def print_bounding_box(bb):
    print(f'bb_left: {bb.bb_left}, bb_top: {bb.bb_top}, bb_width: {bb.bb_width}, bb_height: {bb.bb_height}')
...
if __name__ == "__main__":
    ...
    ax.add_patch(Rectangle((bb1.bb_left,bb1.bb_top), bb1.bb_width, bb1.bb_height, fill=False, edgecolor='red', linewidth=2))
    bb2 = BoundingBox(5, 5, 10, 10)
    print('bb2:')
    print_bounding_box(bb2)
    ax.add_patch(Rectangle((bb2.bb_left,bb2.bb_top), bb2.bb_width, bb2.bb_height, fill=False, edgecolor='blue', linewidth=2))
    bb3 = intersection_box(bb1, bb2)
    ax.add_patch(Rectangle((bb3.bb_left, bb3.bb_top), bb3.bb_width, bb3.bb_height, fill=True,  linewidth=2, color='green'))
    print('bb3:')
